...
# def predict_personality(resume_path, question):
#     # ... (rest of the code from the previous chatbot.py file)
...
#     personality_mapping_reverse = {v: k for k, v in personality_mapping.items()}
#     predicted_personality = personality_mapping_reverse[value]
